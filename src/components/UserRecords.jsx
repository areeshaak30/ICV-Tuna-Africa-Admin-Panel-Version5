          ...
          <tbody>
            {table.map((row) => (
              <tr key={row.no} className="text-center font-inter">
                ...
                <td className="p-2 text-[13px] text-[#475569]">{row.username}</td>
                <td className="p-2 text-[13px] text-[#475569]">{row.VesselName}</td>
                <td className="p-2 text-[13px] text-[#475569]">{row.offloadDate}</td>
                <td className="p-2 text-[13px] text-[#475569]">{row.MarketType}</td>
                <td className="p-2 text-[13px] text-[#475569]">{row.LongFin}</td>
                <td className="p-2 text-[13px] text-[#475569]">{row.TWeight}</td>
                <td className="p-2 text-[13px] text-[#475569]">{row.BigEye}</td>
                <td className="p-2 text-[13px] text-[#475569]">{row.TWeight}</td>
                <td className="p-2 text-[13px] text-[#475569]">{row.YellowFin}</td>
                <td className="p-2 text-[13px] text-[#475569]">{row.SBlueFin}</td>
                <td className="p-2 text-[13px] text-[#475569]">{row.TWeight}</td>
